...
import pygame
from pygame.locals import QUIT, KEYDOWN, KEYUP, K_UP, K_DOWN, K_LEFT, K_RIGHT , K_ESCAPE
import os.path
...
def main():
    ...
    keymap = []
    ship = [0, 0]
    scope_image = pygame.image.load(os.path.join(FILEPATH, "scope.png"))
    rock_image = pygame.image.load(os.path.join(FILEPATH, "rock.png"))
        ...
        for star in stars:
            ...
            if star["pos"][2] < 64:
                if abs(star["pos"][0] - ship[0]) < 50 and \
                    ...
                    game_over = True
                star["pos"] = [randint(-1600, 1600), randint(-1600, 1600), 4905]
